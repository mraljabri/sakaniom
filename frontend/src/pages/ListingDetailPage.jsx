            ...
            <div className="space-y-3">
              ...
              {!phoneRevealed ? (
                <button
                  ...
                  className="press w-full flex items-center gap-3 bg-primary-600 hover:bg-primary-700 text-white rounded-2xl px-4 py-3.5"
                >
                ...
                <>
                  <a href={`tel:${listing.contact_phone}`}
                    className="press flex items-center gap-3 bg-primary-600 hover:bg-primary-700 text-white rounded-2xl px-4 py-3.5">
                    <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href={`https://wa.me/${listing.contact_phone?.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer"
                    className="press flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white rounded-2xl px-4 py-3.5">
              ...
              {listing.show_email && listing.contact_email && (
                <a href={`mailto:${listing.contact_email}`}
                  className="press flex items-center gap-3 border border-gray-200 hover:bg-gray-50 text-gray-700 rounded-2xl px-4 py-3.5">
